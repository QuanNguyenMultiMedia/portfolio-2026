...
export default function PostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black overflow-x-hidden font-serif">
      ...
      <main className="pt-40 pb-32 px-16 md:pl-64 md:pr-24 max-w-[1000px] relative z-10" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
        ...
        <article className="space-y-6 md:space-y-8 text-sm md:text-base leading-relaxed md:leading-[1.65] opacity-80">
