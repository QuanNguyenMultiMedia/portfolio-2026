          ...
          {takes.map((post, idx) => (
            ...
            >
              ...
              <div className="md:col-span-7 space-y-6">
                ...
                <p className="text-lg font-light opacity-70 max-w-[576px] line-clamp-2 leading-relaxed group-hover:opacity-90 transition-opacity">
                  {post.excerpt}
                </p>
              </div>

              <div className="md:col-span-3 flex justify-end">
                <span className="text-2xl opacity-0 group-hover:opacity-100 group-hover:translate-x-4 transition-all duration-500">→</span>
              </div>
            </Link>
          ))}
        </div>
