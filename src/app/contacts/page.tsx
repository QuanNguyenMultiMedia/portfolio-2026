...
const socialLinks = [
  { name: "LINKEDIN", url: "https://www.linkedin.com/in/quannguyenhere/", id: "01" },
  { name: "BEHANCE", url: "#", id: "02" },
  { name: "UPWORK", url: "#", id: "03" },
];

const experience = [
  { company: "Upwork", role: "Freelance Motion Graphic Designer", period: "2020 – Present" },
  { company: "“Z Cũng Viết”", role: "Project Manager & Lead Creative", period: "2023" },
  { company: "Viettel Digital", role: "Lead Content Marketing Intern", period: "2022" },
];
                  ...
                  <div className="lg:col-span-4 p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-primary/10 flex flex-col justify-between min-h-[450px]">
                    <div className="space-y-12">
                       <div className="space-y-4">
                          ...
                          >
                            <span className="group-hover:text-tech-blue transition-colors duration-300 uppercase">QUANNGUYENHERE@GMAIL.COM</span>
                  ...
                  <div className="lg:col-span-4 p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-primary/10 flex flex-col justify-between">
                    <div className="space-y-12">
                      <div className="space-y-2">
                         <h2 className="text-3xl font-display uppercase tracking-tighter leading-none italic">Quan Nguyen</h2>
                         <p className="text-[10px] font-mono tracking-widest opacity-40 uppercase">Multimedia Designer</p>
                      </div>
                           ...
                           {experience.map((exp, i) => (
                             <div key={i} className="space-y-1 group">
                               <div className="flex justify-between items-baseline">
                                 <span className="text-[10px] font-bold tracking-wider uppercase group-hover:text-tech-blue transition-colors duration-300">{exp.company}</span>
                                 <span className="text-[8px] font-mono opacity-30">{exp.period}</span>
                               </div>
                               <p className="text-[9px] opacity-60 uppercase tracking-wide">{exp.role}</p>
                             </div>
                           ))}
                         </div>
                      </div>
                  ...
                  <div className="lg:col-span-8 p-12 md:p-24 lg:p-32 flex flex-col justify-center space-y-16 relative">
                     ...
                     <div className="pt-8 flex justify-between items-center relative z-10 opacity-60">
                        <div className="flex gap-12">
                           <p className="text-[10px] uppercase tracking-[0.2em] font-medium">Motion Graphics</p>
                           <p className="text-[10px] uppercase tracking-[0.2em] font-medium">Visual Systems</p>
                        </div>
                     </div>
                  </div>
                </div>
