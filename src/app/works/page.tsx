          ...
          <div className="col-span-12 lg:col-span-7 flex flex-col justify-center relative min-h-[320px] md:min-h-0 lg:h-full select-none pl-4 pb-16 lg:pb-0">
            <div className="relative w-full h-full flex items-center md:pb-0">
              ...
              <motion.div
                ...
                className="absolute right-[19px] md:right-[25px] 3xl:right-[35px] 4xl:right-[45px] top-1/2 -translate-y-1/2 w-[120px] h-[120px] md:w-[160px] md:h-[160px] 3xl:w-[240px] 3xl:h-[240px] 4xl:w-[320px] 4xl:h-[320px] flex items-center justify-center z-20"
              >
                <div
                  ref={dialRef}
